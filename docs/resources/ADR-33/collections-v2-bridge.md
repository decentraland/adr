...
The architecture of how collections will be represented between layers is already defined [here](https://github.com/decentraland/adr/blob/main/docs/ADR-4-collections-architecture-in-L1-L2.md).
