...
Decentraland explorers connect to different communications transports via connection strings, those are URL-like identifiers containing all the information to select the technology and establish the connection to the target network.
