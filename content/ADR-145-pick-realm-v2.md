...
- Addition of new rules:
  ...
  - Catalyst Version: Nodes with a version lower than the minimum required version (_as specified in the configuration_) will be excluded from selection. This will allow us setting minimum required version for each service running within a Catalyst.
