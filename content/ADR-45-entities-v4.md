...
- Wearables size will be validated without taking into account the generated images (thumbnail and image with rarity background) and a new size limit will be set ([see updates](./ADR-246-update-max-size-for-skins-and-thumbnail-validation-for-wearables.md)):
  - Total size: 3MB
